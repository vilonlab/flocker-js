...
import { ExperimentRoomState, PlayerState } from "./schema/ExperimentRoomState";
...
export class ExperimentRoom extends Room<ExperimentRoomState> {
    ...
    private maxRounds: number = 9;
    private roundDuration: number = 60 * 1000;
    private roundTimer: NodeJS.Timeout | null = null;
    private logTimer: NodeJS.Timeout | null = null;
    // private dataLogger: DataLogger;
    private logInterval: number = 1000;
    private playersInZones: { [key: string]: Set<string> } = {};
