...
class PlayerState extends Schema {
    ...
    @type("string") declare currentEmote: string | null;
    @type("string") declare role: string;
    @type("boolean") declare ready: boolean;
    @type("number") declare targetX: number | null;
    @type("number") declare targetY: number | null;
...
class ExperimentRoomState extends Schema {
    ...
    @type("string") declare targetZone: string | null;
