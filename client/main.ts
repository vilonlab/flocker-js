import PreloadScene from './src/scenes/PreloadScene.ts';
import GameScene from './src/scenes/GameScene.ts';
import SceneSelector from './src/scenes/SceneSelector.ts'
...
const config = {
    ...
    scene: [PreloadScene, GameScene, SceneSelector] // Scenes registry
};
